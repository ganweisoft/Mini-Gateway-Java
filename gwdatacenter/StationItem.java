...
public final class StationItem
{
	...
	public static sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> SetParmResultEvent = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>(); //通知执行设置后的结果 add by sd in 20190316
	public static sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> SetParmResponseEvent = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>(); //通知执行设置后的响应值（不是返回值），这个事件通常在dll中去执行

	public static sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> AppClose = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>(); //程序关闭事件
	public static sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> RightHandWave = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>();
	public static sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> LeftHandWave = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>();

	public static sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> StationCommError = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>();
	public static sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> StationCommOk = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>();
	public static sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> StationHaveAlarm = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>();
	public static sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> StationNoAlarm = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>();

	public static sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> EquipBackUpChanged = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>(); //备份状态发生改变

	public static sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> HaveEquipChanged = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>(); //发生设备动态添加、删除、修改的事件
	public static sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> HaveEquipReset = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>(); //发生设备配置重置事件
	...
	public static void FireSetParmResultEvent(SetItem item)
	{
		...
		{
			for (EventHandler<sharpSystem.EventArgs> listener : SetParmResultEvent.listeners())
			{
	...
	public static void DoHaveEquipChanged(SubEquipList SE)
	{
		...
		{
			for (EventHandler<sharpSystem.EventArgs> listener : HaveEquipChanged.listeners())
			{
	...
	*/
	...
	public static sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> ChangedEquipListChanged = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>(); //动态添加、删除、修改设备状态发生改变
	public static DelayEventFire ChangedEquipListChangedDelayEvent = null;

	public static sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> AddNewSubEquipList = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>(); //动态添加了一个新的设备通讯线程
	...
	*/
	public static void AddChangedEquip(ChangedEquip Eqp)
	{
		...
		{
			ChangedEquipListChanged.addListener("StationItem_ChangedEquipListChanged", (Object sender, sharpSystem.EventArgs e) -> StationItem_ChangedEquipListChanged(sender, e));
	...
	private static void StationItem_ChangedEquipListChanged(Object sender, sharpSystem.EventArgs e)
	{
		synchronized (ChangedEquipList)
		{
	...
	public static SubEquipList GetSubEquipList(int iStaNo, int iEqpNo, ChangedEquipState State)
	{
		...
		synchronized (StationItem.EquipCategoryDict)
		{
			...
			if (rtnSubEquipList == null)
			{
				...
				{
					for (sharpSystem.EventHandler<sharpSystem.EventArgs> listener : AddNewSubEquipList.listeners())
					{
