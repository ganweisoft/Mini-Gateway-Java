...
public class MqttProvider
{
	...
	public sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> EquipInited = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>();
}