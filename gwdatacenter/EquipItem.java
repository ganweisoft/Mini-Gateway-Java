...
public class EquipItem implements ICanReset, java.lang.Comparable
{
	private int istano;
	...
	public sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> EquipCommError = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>();
	public sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> EquipCommOk = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>();
	public sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> EquipHaveAlarm = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>();
	public sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> EquipNoAlarm = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>();
	...
	*/
	...
	public sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>> RevEqpEvt = new sharpSystem.Event<sharpSystem.EventHandler<sharpSystem.EventArgs>>(); //收到设备的通讯事件，比如：用于门禁设备的刷卡记录
	public final void DoRevEqpEvt(EquipEvent Evt)
	{
		if (RevEqpEvt != null)
		{
			for (sharpSystem.EventHandler<sharpSystem.EventArgs> listener : RevEqpEvt.listeners())
			{
